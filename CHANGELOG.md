...
## [9.2.0](https://github.com/Kehl-io/nestweaver/compare/v10.0.7...v9.2.0) (2026-09-20)
...
* **release:** drop the self-comparing 9.2.0 section from the release PR ([9963692](https://github.com/Kehl-io/nestweaver/commit/99636926057ee719418d0124c5aa5331cf7e8096))
...
* remediate unblocked backlog items (2026-09) ([#396](https://github.com/Kehl-io/nestweaver/issues/396)) ([3032390](https://github.com/Kehl-io/nestweaver/commit/3032390e3a4213731e18ef4f9f1f5e3e9d2972b1))
...
This release updates LadybugDB from 0.19.1 to 0.20.4 and changes the database storage format. Before upgrading, stop NestWeaver and save a database backup using the currently installed version. Older NestWeaver executables cannot open databases written in the new format; rollback requires restoring the pre-upgrade backup. Upgrade, restart, graph preservation, search, and backup restoration were validated on isolated databases, including a copy of a real-world knowledge vault.
