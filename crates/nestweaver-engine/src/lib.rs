...
pub use index_md::{
    ...
    index_markdown_directory_with_ignore_and_write_lease,
    index_markdown_directory_with_ignore_and_write_lease_and_note_limits,
    index_markdown_directory_with_note_limits, index_markdown_directory_with_store,
