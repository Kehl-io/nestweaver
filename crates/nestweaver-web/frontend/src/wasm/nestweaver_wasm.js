/* @ts-self-types="./nestweaver_wasm.d.ts" */
...
export class WasmGraph {
     ...
     */
    generation() {
        const ret = wasm.wasmgraph_generation(this.__wbg_ptr);
    ...
    constructor(data) {
        ...
        const ret = wasm.wasmgraph_new(ptr0, len0);
        if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nestweaver_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
