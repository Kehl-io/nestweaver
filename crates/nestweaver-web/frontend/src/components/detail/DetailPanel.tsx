...
export function DetailPanel() {
  ...
  if (!selectedNodeId) {
    return (
      <div className="flex h-full flex-col items-center justify-center gap-3 border-l border-[var(--color-border)] bg-[var(--color-surface)] p-6 text-center text-sm text-[var(--color-text-muted)]">
  ...
  return (
    <div className="h-full border-l border-[var(--color-border)] bg-[var(--color-surface)]">
