...
All **43** NestWeaver MCP tools are available in Windsurf's AI features, including type-aware context, confidence-weighted impact analysis, investigation bundles, and vault/notes integration.
