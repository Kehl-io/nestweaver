...
4. Use `detect_changes` with the list of files you expect to modify for a risk level and gate (the same verdict `blast_radius` gives; affected processes are detail)
